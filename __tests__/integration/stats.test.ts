...
describe("tg stats --plan shows plan summary and per-task elapsed table", () => {
...
describe("tg stats --timeline shows cross-plan execution history", () => {
  let context: Awaited<ReturnType<typeof setupIntegrationTest>> | undefined;
...
describe("tg stats shows Token Usage section when self-report data exists", () => {
  let context: Awaited<ReturnType<typeof setupIntegrationTest>> | undefined;
...
describe("tg stats does NOT show Token Usage section when no self-report data", () => {
  let context: Awaited<ReturnType<typeof setupIntegrationTest>> | undefined;
