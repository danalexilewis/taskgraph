...
1. **Integration Test Isolation Fixes** — The 9 recommended fixes from the investigator's report (`reports/26-03-01_review-integration-test-isolation.md`). Not yet a plan; proposed changes.
