    ...
    program
        ...
        const initResult = await neverthrow_1.ResultAsync.fromPromise((async () => {
            ...
            if (!(0, fs_1.existsSync)(doltRepoPath)) {
                ...
                await (0, execa_1.execa)("dolt", ["init"], { cwd: taskGraphPath });
        ...
        (e) => (0, errors_1.buildError)(errors_1.ErrorCode.DB_QUERY_FAILED, "Failed to initialize Dolt repository", e))
            ...
            return (0, utils_1.writeConfig)(config).mapErr((e) => (0, errors_1.buildError)(errors_1.ErrorCode.UNKNOWN_ERROR, "Failed to write config", e));
        });
        initResult.match(() => {
