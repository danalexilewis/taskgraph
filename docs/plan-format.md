...
| Field              | Type   | Stored in Dolt           | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------------------ | ------ | ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `agent`            | string | `task.agent`             | Single slug or array specifying the agent or sub-agent to execute this task. Use `agent: debugger` for debugging tasks (root-cause investigation, failing tests with unknown cause). Use **`agent: documenter`** for tasks that only or mostly touch documentation (docs/, README, CHANGELOG, .cursor rules); the implementer is scoped to exclude doc edits, so doc-only tasks need the documenter so /work dispatches a sub-agent instead of the orchestrator doing direct execution. |
