...
**Agent contract and workflow:** The agent system is documented across AGENT.md (canonical contract), [agent-contract.md](agent-contract.md), [agent-strategy.md](agent-strategy.md), [multi-agent.md](multi-agent.md), and [docs/leads/](leads/) (lead registry and per-lead docs).
